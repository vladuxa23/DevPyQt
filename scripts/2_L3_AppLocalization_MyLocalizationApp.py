...
class MyTranslateApp(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        self.QT_TRANSLATIONS_PATH = "C:/Python397/Lib/site-packages/PySide2/translations/"
    ...
    def setLocalization(self, lang):
        ...
        self.translator.load(f"to_{lang}")  # Загружаем созданный нами файл qm, можно указывать без расширения
