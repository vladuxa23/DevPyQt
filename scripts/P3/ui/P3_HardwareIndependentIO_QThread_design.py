...
################################################################################
## Form generated from reading UI file 'P3_HardwareIndependentIO_QThread_design.ui'
##
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pushButtonTimerStart = QPushButton(self.frame)
        self.pushButtonTimerStart.setObjectName(u"pushButtonTimerStart")
        self.pushButtonTimerStart.setCheckable(True)

        self.verticalLayout.addWidget(self.pushButtonTimerStart)
    ...
    def retranslateUi(self, Form):
        ...
        self.pushButtonTimerStart.setText(QCoreApplication.translate("Form", u"\u041d\u0430\u0447\u0430\u0442\u044c \u043e\u0442\u0441\u0447\u0451\u0442", None))
