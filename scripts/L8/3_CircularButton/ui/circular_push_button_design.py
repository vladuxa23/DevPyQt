################################################################################
## Form generated from reading UI file 'circular_push_button_design.ui'
##
...
class Ui_CircularPB(object):
    def setupUi(self, CircularPB):
        ...
        CircularPB.resize(143, 145)
        CircularPB.setMinimumSize(QSize(140, 140))
        CircularPB.setMaximumSize(QSize(143, 145))
...
"color: #FFFFFF}")
    ...
    def retranslateUi(self, CircularPB):
        ...
        self.labelTitle.setText(QCoreApplication.translate("CircularPB", u"<html><head/><body><p><span style=\" font-weight:400; color:#fff;\">\u0412\u044b\u043f\u043e\u043b\u043d\u0438\u0442\u044c</span></p><p><span style=\" font-weight:400; color:#fff;\"> \u0437\u0430\u043f\u0440\u043e\u0441</span></p></body></html>", None))
    # retranslateUi
